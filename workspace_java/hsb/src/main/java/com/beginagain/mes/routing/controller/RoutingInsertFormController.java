...
@WebServlet("/routing/insertForm")
public class RoutingInsertFormController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/routing/routingInsert.jsp").forward(request, response);
    }
}
