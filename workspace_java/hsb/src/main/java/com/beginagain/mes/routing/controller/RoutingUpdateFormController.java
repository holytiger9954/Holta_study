...
@WebServlet("/routing/updateForm")
public class RoutingUpdateFormController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/routing/routingUpdate.jsp").forward(request, response);
    }
}
