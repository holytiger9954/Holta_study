...
@WebServlet("/bom/insertForm")
public class BomInsertFormController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/bom/bomInsert.jsp").forward(request, response);
    }
}
