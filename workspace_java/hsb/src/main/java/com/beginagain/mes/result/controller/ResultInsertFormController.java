...
@WebServlet("/result/insertForm")
public class ResultInsertFormController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/result/resultInsert.jsp").forward(request, response);
    }
}
