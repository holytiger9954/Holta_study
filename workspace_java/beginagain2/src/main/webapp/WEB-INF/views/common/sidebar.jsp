        ...
        <nav class="sidebar-nav">
			...
			<div class="menu-group">
				...
				<div class="menu-items open">
					<a href="${pageContext.request.contextPath}/ceomain">ceo 메인</a> 
					<a href="${pageContext.request.contextPath}/adminmain">mes관리자 메인</a>
					<a href="${pageContext.request.contextPath}/prodmain">생산관리 메인</a> 
					<a href="${pageContext.request.contextPath}/notice">공지사항</a> 
					<a href="${pageContext.request.contextPath}/suggestion">건의사항</a> 
				</div>
			</div>
